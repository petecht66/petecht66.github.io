...
# Introduction and Research Question {: .mx-auto.d-block :}
...
# Methodology {: .mx-auto.d-block :}
## Key Pass Coverage Schemes {: .mx-auto.d-block :}
...
| Coverage Name | Description | {: .mx-auto.d-block :}
| :------ |:--- | :--- |
...
**Table 1**: This table details the ten different defensive pass coverage schemes most commonly used in the NFL. Descriptions come from Pro Football Focus (PFF). {: .mx-auto.d-block :}